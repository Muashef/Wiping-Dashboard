  ...
  <div className="">
    ...
    <div className='w-full h-screen lg:overflow-hidden grid grid-cols-1 lg:grid-cols-[13rem_1fr] items-stretch'>
        ...
        <div className=''>
            ...
            <div className='w-full h-[25.125rem] mx-auto px-8 gap-x-14 grid grid-cols-2 lg:grid-cols-3 items-center justify-center mt-[-90px]'>
                <div className=' bg-white p-6 shadow-md rounded-md w-[21.60625rem]'>
                    <h1 className='text-[#232360] text-xl font-bold border-b-2 w-1/3 h-7'>D.A.U</h1>
                ...
                <div className=' bg-white p-6 shadow-md rounded-md w-[21.60625rem]'>
                    <h1 className='text-[#232360] text-xl font-bold border-b-2 w-1/3 h-7'>W.A.U</h1>
                    <div className='flex justify-between mt-4'>
                        <div>
                ...
                <div className=' bg-white p-6 shadow-md rounded-md w-[21.60625rem]'>
                    <h1 className='text-[#232360]  text-xl font-bold border-b-2 w-1/3 h-7'>M.A.U</h1>
                    <div className='flex justify-between mt-4'>
                        <div>
            ...
            <div className='w-[870px] mx-auto mt-[-100px] border border-white p-5 shadow-md rounded-lg'>
                <AreaChart />
            </div>
        </div>
